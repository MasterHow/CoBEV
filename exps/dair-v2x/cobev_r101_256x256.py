...
from models.cobev_ablations import CoBEVAblations
...
class CoBEVLightningModel(LightningModule):
    ...
    def __init__(self,
        ...
        backbone_conf['fusion_method'] = kwargs['fusion_method']
        ...
        self.model = CoBEVAblations(self.backbone_conf, self.head_conf)
        self.mode = 'valid'
...
def main(args: Namespace) -> None:
    ...
    checkpoint_callback = ModelCheckpoint(dirpath=args.default_root_dir+'/checkpoints', filename='{epoch}', every_n_epochs=5, save_last=True, save_top_k=-1)
...
def run_cli():
    ...
    parent_parser.add_argument('--fusion_method', type=str)
    ...
    parser.set_defaults(
        ...
        precision=32,
        default_root_dir='/workspace/mnt/storage/shihao/Data-Yara/BEV_Det/cobev_dair_r101_256x256')
