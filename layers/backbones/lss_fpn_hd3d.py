...
from layers.backbones.fusion_3d import openocc_voxel_pooling, VisFuser
...
class LSSFPNHD3D(nn.Module):
    def __init__(self, x_bound, y_bound, z_bound, d_bound, height_bound, final_dim,
                 ...
                 img_neck_conf, depth_height_net_conf):
        ...
        super(LSSFPNHD3D, self).__init__()
        ...
        self.depth_height_feature_fuse = VisFuser(80, 80)
