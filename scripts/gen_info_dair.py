...
def main():
    dair_root = "/workspace/mnt/storage/pangchengshan/exp/dataset/dair-v2x-i-kitti"
    train_infos = generate_info_dair(dair_root, split='train')
    val_infos = generate_info_dair(dair_root, split='val')
    
    mmcv.dump(train_infos, dair_root+'/dair_12hz_infos_train.pkl')
    mmcv.dump(val_infos, dair_root+'/dair_12hz_infos_val.pkl')
