...
from layers.backbones.lss_fpn_hd3d_ablations import LSSFPNHD3DAblations
from layers.heads.bev_height_head import BEVHeightHead

__all__ = ['CoBEVAblations']


class CoBEVAblations(nn.Module):
    """
    Args:
    ...
    def __init__(self, backbone_conf, head_conf, is_train_height=False):
        super(CoBEVAblations, self).__init__()
        self.backbone = LSSFPNHD3DAblations(**backbone_conf)
